...
const GroovFTPClient = require("./groov-ftp-client");
const GroovSCPClient = require("./groov-scp-client");
 ...
 * @param {object} ftpConfig Configuration for FTP server.
 * @param {string} ftpConfig.hostname Host name for FTP server.
 * @param {string} ftpConfig.username Username for FTP server.
 * @param {string} ftpConfig.password Password for FTP server.
 */
function GroovPreserver(clientConfig, ftpConfig) {
  this.groov = new GroovClient(clientConfig);
  this.ftp = new GroovFTPClient(ftpConfig);
  this.scp = new GroovSCPClient(ftpConfig);
}
...
GroovPreserver.prototype.saveData = function() {
  ...
  // this.ftp.uploadRecipeFiles();
  this.scp.uploadRecipeFiles();
