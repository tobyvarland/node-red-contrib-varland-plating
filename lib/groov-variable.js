...
GroovVariable.RECIPE_VARIABLE_PREFIX = "r";
GroovVariable.HISTORIAN_VARIABLE_PREFIX = "h";
GroovVariable.VARIABLE_SEPARATOR = "_";
GroovVariable.LOG_TRIGGER_REGEX = /^(r|h|rh|hr)?b_([A-Za-z0-9]+(_[A-Za-z0-9]+)*)_Log$/;
GroovVariable.VALID_NAME_REGEX = /^((r|h|rh|hr)?(ai|ao|b|bt|di|do|dt|f|ft|i|it|s|st|ut))(_([A-Za-z0-9]+))+$/;
GroovVariable.LOCAL_RECIPE_FOLDER = "/home/dev/secured/recipe_data/";
 ...
 * @returns {boolean}
 */
GroovVariable.isValidName = function(name) {
 ...
 */
GroovVariable.prototype.parseName = function() {
  ...
  if ((m = GroovVariable.LOG_TRIGGER_REGEX.exec(this.name)) !== null) {
    ...
    this.logDetails = {
      id: m[2],
      logTypeVariable: "s_LogType_" + m[2],
      variableNamesTable: "st_Variables_" + m[2],
      fieldNamesTable: "st_Fields_" + m[2],
    };
  }
