...
/** @class GroovHistorian used for logging variable values to InfluxDB. */
class GroovHistorian {
   ...
   */
  constructor(influxConfig, clientConfig) {
  ...
  historize() {
    ...
    if (this.points.length > 0) this.writePoints()
   ...
   */
  addTableElement(name, index, value) {
