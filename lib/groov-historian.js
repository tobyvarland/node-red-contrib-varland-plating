...
/**
 * @property {string} FLAG_VARIABLE Name of controller flag to set after logging to historian.
 */
 GroovHistorian.FLAG_VARIABLE = "b_Historized";
...
GroovHistorian.prototype.historize = function() {
  ...
  this.processVariables(this.groov.getStrings());
  ...
  if (this.points.length > 0) {
    this.writePoints();
    this.groov.setInteger(GroovHistorian.FLAG_VARIABLE, true);
  }
